...
class Vector {
    ...
    add(v2) {return new Vector(this.x + v2.x, this.y + v2.y, this.z + v2.z);}
    subtract(v2) {return new Vector(this.x - v2.x, this.y - v2.y, this.z - v2.z);}
    multiply(scalar) {return new Vector(this.x * scalar, this.y * scalar, this.z * scalar);}
}
